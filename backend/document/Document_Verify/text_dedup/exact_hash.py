...
def main(
    ...
    with timer("Total"):
        ...
        with timer("Processing"):
            ...
            ds = ds['train']
            #print(meta_args.column, ds)

            for example in tqdm(ds[meta_args.column], desc="Processing..."):
    ...
    result = len(flags) - len(ds)
    if result!=0:
        result=0 #duplicated (not success)
    else:
        result=1 #not duplicated (success)
